---
layout: post
title:  CPanel / IPIntel.ai automated suspicious IP checker / Blocker"
author: dave
date:   2026-03-13 22:20:14 +0200
categories: [Web, Security]
tags: [Website, Security, PHP]
published: false
---
...
CREATE TABLE security_events (
    ...
    eventtype VARCHAR(50) NOT NULL, -- e.g. 'failedlogin', 'sqlinjection', 'ratelimit'
    details TEXT NULL,
    createdat TIMESTAMP DEFAULT CURRENTTIMESTAMP,
    INDEX idxipcreatedat (ip, createdat),
    INDEX idxeventtype (event_type)
);
...
CREATE TABLE ip_bans (
    ...
    source VARCHAR(50) NOT NULL, -- 'app', 'manual', 'cloudflare_sync', etc.
    is_active TINYINT(1) DEFAULT 1,
    bannedat TIMESTAMP DEFAULT CURRENTTIMESTAMP,
    expires_at TIMESTAMP NULL DEFAULT NULL,
    lastsyncedcloudflare_at TIMESTAMP NULL DEFAULT NULL,
    lastsyncedcpanel_at TIMESTAMP NULL DEFAULT NULL,
    UNIQUE KEY uniq_ip (ip),
    INDEX idxisactive (is_active),
    INDEX idxexpiresat (expires_at)
);
