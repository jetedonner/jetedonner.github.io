---
layout: post
title:  "FFMpegGUI - SwiftUI app to extract, convert, resample media files and more"
author: dave
date:   2026-04-28 01:31:37 +0200
...
## 🎬 Project Goals
FFMpegGUI was created with several goals in mind:
...
FFMpegGUI consists of two cooperating components:
...
- Receives the file URL via `.onOpenURL.
...
```swift
ffmpeggui://process?file=/path/to/movie.mp4
```
...
This makes them ideal for system‑wide utilities like FFMpegGUI.
...
```swift
let urlString = "ffmpeggui://process?file=\(encodedPath)"
...
FFMpegGUI is designed to be extended.
...
FFMpegGUI provides a fast, native macOS workflow for extracting audio from video files using:
...
- [FFMpegGUI - macOS SwiftUI App](https://github.com/jetedonner/FFMpegGUI){:target="_blank" rel="noopener"}
